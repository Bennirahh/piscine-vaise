...
module.exports = {
  entry: {
    theme: path.resolve(environment.paths.source, 'js', 'scripts'),
  },
  output: {
    filename: 'js/[name].js',
  ...
  plugins: [
    ...
    new CopyWebpackPlugin({
      patterns: [
        ...
        {
          from: path.resolve(environment.paths.source, 'img/svg'),
          to: path.resolve(environment.paths.output, 'img/svg'),
          toType: 'dir',
          globOptions: {
            ignore: ['*.DS_Store', 'Thumbs.db'],
          },
